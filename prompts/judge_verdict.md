...
- suspicious (40-59): 核心建议可能有一定道理，但表述夸张、来源不明、缺少细节，或存在煽情/夸大。属于"不完全错但不够严谨"。
...
### 5. 一般评分区间
- 80-100: safe — 内容基本属实，核心建议有科学依据。
- 60-79: needs-verification — 核心建议可能有道理，但缺少权威来源确认，或搜索结果有限。建议谨慎对待，不急着转发。
- 40-59: suspicious — 核心建议部分有道理，但混合了错误信息，或来源不可考，或表述明显夸张。
- 10-39: misinformation — 明确的伪科学或谣言，核心建议是错的。
- 0-9: scam — 诈骗。
...
- **外部链接**：消息中可能包含 URL。你**可以通过联网搜索来访问和验证这些链接的内容**。基于链接内容和搜索结果综合判断可信度。
